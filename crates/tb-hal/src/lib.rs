...
// ===========================================================================
// The verified-leaf SELF-TEST FACADE seam (L2.0..L2.6 + M19..M26 proofs +
// *_selftest facades) is extracted to the `verified_leaf` module for
// readability. The crate-root glob re-export preserves every `tb_hal::*Proof` /
// `tb_hal::*_selftest` / `crate::*Proof` path -- a behaviour-preserving move.
// ===========================================================================
mod verified_leaf;
pub use verified_leaf::*;
