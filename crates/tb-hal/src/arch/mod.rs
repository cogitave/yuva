...
#[cfg(target_arch = "x86_64")]
pub use self::x86_64::{
    address_space_new, agent_map_space, agent_traps_init, boot_ready_signal, breakpoint,
    ...
    timer_rearm, tsc_base_hz, unmap_in_root, user_demo, va_to_pa_in_root, virtio_selftest,
    vmx_selftest,
};
...
pub use self::aarch64::{
    ...
    el2_nested_guest_selftest, el2_selftest, el2_trap_selftest, el2_vgic_selftest, halt, qemu_exit_success, boot_entry_el, booted_at_el2,
