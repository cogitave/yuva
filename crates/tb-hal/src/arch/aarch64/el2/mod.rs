...
// --- L2.1 stage-2 demand rung: extracted to the `l21_stage2` child module -----
// (the naked guest stub + the safe facade; the dispatch-called demand-fault
// handler + the shared eret-retry stay below; a pure behavior-preserving move).
mod l21_stage2;
pub use l21_stage2::stage2_selftest;

// --- L2.0 smoke rung: extracted to the `l20_smoke` child module ---------------
// (the safe el2_selftest facade; the dispatch-referenced guest stub stays
// below next to the central match; a pure behavior-preserving code move).
mod l20_smoke;
pub use l20_smoke::el2_selftest;
