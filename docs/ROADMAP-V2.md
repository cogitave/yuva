...
| **M16** (LLM-agnostic inference bridge) | ⏳ **in progress** (next increment) — builds on the M14 channel + M12 agent runtime toward the `model:` inference scheme |
| M17 – M18 | ⬜ planned (this document) |
