...
> Status: **the full v2 chain M5→M18 is COMPLETE and CI-green on both arches** (atop the v1 M0–M4 foundation + L1 sovereignty / tb-vmm). M18, the self-improving capstone, lands the frozen-kernel / evolving-userspace split — the final milestone of the chain.
