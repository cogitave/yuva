...
| **M17** (sleep-time consolidation / reflection / forgetting daemons) | ⏳ **in progress** (next increment) — builds on the M13 substrate + M16 inference + M9 scheduler toward sleep-time memory daemons |
| M18 | ⬜ planned (this document) |
